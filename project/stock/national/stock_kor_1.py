...
def get_target_price(code: str="005930"):
...
def get_symbol():
    url = "https://kr.investing.com/etfs/south-korea-etfs"
...
try:
    ...
    target_buy_count: int = 5 # 매수할 종목 수
    buy_percent: float = 0.20 # 종목당 매수 금액 비율
    ...
    while True:
        ...
        if t_start < t_now < t_end :  # AM 09:05 ~ PM 03:15 : 매매
                    ...
                    if macd=='long' and rsi=='long':
                        ...
                        if buy_qty > 0:
                            ...
                            if result:
                                ...
                                print(get_bgt_qty())
                    time.sleep(1)
                    if t_now.minute%20==0 and flags[sym]==0:
                        if macd=='long' and rsi=='long':
        ...
        if t_end < t_now < t_exit:  # PM 03:15 ~ PM 03:20 : 일괄 매도
            if soldout == False:
                stock_dict = get_stock_balance()
                for sym, qty in stock_dict.items():
                    sell(sym, qty)
